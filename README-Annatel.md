...
- if you need to add other changes, add them now.(find other ranges (i.e. M2M, IOT/M2M...) at https://data.gov.il/he/datasets/tikshoret/israel-numbering-plan/74b44725-d8cc-4ae9-ba08-2c40a61ab68e)
- check that the changes look good; you should see a small number (~4-5) of new or changed files: `git status`
